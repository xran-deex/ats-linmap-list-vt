...
absvtype
linmap_node_vtype
  (key:vt@ype, itm:vt@ype+, l:addr) = ptr(l)
...
//
vtypedef
mynode (key:vt0p, itm:vt0p) = [l:addr] mynode (key, itm, l)
vtypedef
mynode0 (key:vt0p, itm:vt0p) = [l:addr | l >= null] mynode (key, itm, l)
vtypedef
mynode1 (key:vt0p, itm:vt0p) = [l:addr | l >  null] mynode (key, itm, l)
//
(* ****** ****** *)
...
fun{}
mynode_null
  {key:vt0p;itm:vt0p} ():<> mynode (key, itm, null)
//
praxi
mynode_free_null
  {key:vt0p;itm:vt0p} (nx: mynode (key, itm, null)): void
//
(* ****** ****** *)
