...
assume
map_vtype (k:vt0p, i:vt0p) = List0_vt @(k, i)
...
| @list_vt_cons
    (kx, kxs1) => let
    val kxs1 = kxs1
    val () = linmap_freelin$clear<key,itm> (kx.0, kx.1)
    val () = free@{ki}{0}(kxs)
  in
    aux (kxs1)
